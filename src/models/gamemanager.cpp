...
void Gamemanager::load_shader(
  ...
  const char *vertex_shader_path =
      shader_program_configuration.vertex_shader_path;
  const char *fragment_shader_path =
      shader_program_configuration.fragment_shader_path;
  ...
  Gamemanager::loaded_shaders[shader_program_configuration
                                  .shader_program_name] = shader;
}
...
void Gamemanager::load_sprite(const char *sprite_path){
